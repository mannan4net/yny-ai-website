# PAAI — Engineering & Deployment Architecture (L3)

## Document Information
- Document ID: EA-PAAI-L3
...
## 1. Purpose
This document provides the concrete engineering blueprint for PAAI, mapping the actual containerized services, databases, messaging brokers, cloud networks, ports, and technology stacks.

## 2. Technology Stack & Deployment
- **Core Technology Stack**: Spring Boot, WSO2, Vector DB, Embedding Models, Enterprise Systems, Multi-channel AI
...
![PAAI L3 Diagram](assets/engineering-architecture.svg)
