# SDLC Factory — Engineering & Deployment Architecture (L3)

## Document Information
- Document ID: EA-SDLC Factory-L3
...
## 1. Purpose
This document provides the concrete engineering blueprint for SDLC Factory, mapping the actual containerized services, databases, messaging brokers, cloud networks, ports, and technology stacks.

## 2. Technology Stack & Deployment
- **Core Technology Stack**: n8n, BPMN, SRS Parser, Code Synthesis, QA Runner, Docker, git
...
![SDLC Factory L3 Diagram](assets/engineering-architecture.svg)
