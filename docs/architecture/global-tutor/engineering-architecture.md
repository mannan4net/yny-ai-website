# Global Tutor — Engineering & Deployment Architecture (L3)

## Document Information
- Document ID: EA-Global Tutor-L3
...
## 1. Purpose
This document provides the concrete engineering blueprint for Global Tutor, mapping the actual containerized services, databases, messaging brokers, cloud networks, ports, and technology stacks.

## 2. Technology Stack & Deployment
- **Core Technology Stack**: Go, React, WebRTC Janus, Redis, PostgreSQL, Kafka, Microservices
...
![Global Tutor L3 Diagram](assets/engineering-architecture.svg)
