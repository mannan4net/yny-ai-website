# LegalPA — Engineering & Deployment Architecture (L3)

## Document Information
- Document ID: EA-LegalPA-L3
...
## 1. Purpose
This document provides the concrete engineering blueprint for LegalPA, mapping the actual containerized services, databases, messaging brokers, cloud networks, ports, and technology stacks.

## 2. Technology Stack & Deployment
- **Core Technology Stack**: FastAPI, PyTorch OCR, Milvus Vector DB, Neo4j, Private LLM, Citation Engine
...
![LegalPA L3 Diagram](assets/engineering-architecture.svg)
